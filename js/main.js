...
/* harmony import */ var _components_portfolio_tabs_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/portfolio-tabs.js */ "./src/js/components/portfolio-tabs.js");
/* harmony import */ var _components_portfolio_tabs_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_portfolio_tabs_js__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _components_burger_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_burger_js__WEBPACK_IMPORTED_MODULE_4__);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vendor_choices_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vendor/choices.min.js */ "./src/js/vendor/choices.min.js");
/* harmony import */ var _vendor_choices_min_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vendor_choices_min_js__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _vendor_smooth_scroll_min_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/smooth-scroll.min.js */ "./src/js/vendor/smooth-scroll.min.js");
/* harmony import */ var _vendor_smooth_scroll_min_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_vendor_smooth_scroll_min_js__WEBPACK_IMPORTED_MODULE_3__);
...
if (burger) {
  burger.addEventListener("click", function () {
    ...
    document.querySelector('.sidebar').classList.toggle("_active");
...
window.addEventListener("DOMContentLoaded", checkedScroll);
...
function checkedScroll() {
  ...
  if (scrollPos > 71) {
    header.classList.add("header__static");
    header.classList.remove("header--main");
  } else {
    header.classList.remove("header__static");
...
var popup = document.querySelectorAll('.positions-looking__btn');
...
popup.forEach(function (elem) {
  elem.addEventListener('click', function (e) {
    ...
    var path = e.currentTarget.getAttribute('data-popup');
...
var portfolioSlider = new Swiper(portSlider, {
  ...
  on: {
    ...
    slideChange: function slideChange() {
      ...
      var nextActiveSlide = activeSlide.nextElementSibling;
      var nextNextActiveSlide = nextActiveSlide.nextElementSibling;
      document.querySelectorAll('.portfolio-section__items .swiper-slide').forEach(function (elem) {
...
var fooBar = bodyStyle.getPropertyValue('--hero-slider-speed'); //get
